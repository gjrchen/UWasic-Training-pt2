...
def get_control_signal_array_gltest(dut):
    ...
    Eu = dut.user_project._id("\\cb.control_signals[2]", extended = False).value & dut.rst_n.value
    ...
    Ep = dut.user_project._id("\\cb.control_signals[13]", extended = False).value & dut.rst_n.value
